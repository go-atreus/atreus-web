...
import type { SysI18nListVo, SysMenuDto, SysMenuQo, SysMenuVo } from '@/services/atreus/system';
import { i18n, menu } from '@/services/atreus/system';
    ...
    <>
      <Page.Modal<SysMenuVo, SysMenuQo, SysMenuDto>
        ...
        query={() => {
          return menu
            .query({})
            .then((res) => ({ ...res, data: { results: res.data.results, total: res.data.results?.length || 0 } }));
        }}
        title="菜单权限"
        rowKey="id"
        columns={dataColumns}
