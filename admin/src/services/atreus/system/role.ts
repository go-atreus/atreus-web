...
export async function query(body: QueryParam<SysRoleQo>) {
  return request<R<PageResult<SysRoleVo>>>('/api/system/role/list', {
    method: 'POST',
    data: body,
  });
}
...
export async function create(body: SysRole) {
  return request<R<any>>('/api/system/role/create', {
    method: 'POST',
    data: body,
  });
}
...
export async function listRoleBindUser(body: QueryParam<SysRoleBindQo>) {
  return request<R<PageResult<SysRoleBindVo>>>('/api/system/role/list', {
    method: 'GET',
    params: body,
  });
}
